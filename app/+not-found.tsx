...
const styles = StyleSheet.create({
    container: {
        flex: 1,
        backgroundColor: "rgba(131, 69, 69, 0.4)", // Warna latar belakang gelap
    },
    background: {
        position: "absolute",
        top: 0,
    ...
    card: {
        marginBottom: 16,
        borderRadius: 12,
        backgroundColor: "#1f1b24", // Warna latar belakang kartu
        padding: 16,
    },
    input: {
        backgroundColor: "#2c2c34", // Warna latar belakang input
        color: "#ffffff", // Teks input berwarna putih
        marginBottom: 12,
    },
    updateButton: {
        marginTop: 12,
        backgroundColor: "#6A1B9A", // Warna tombol ungu gelap
        borderRadius: 8,
    },
    updateButtonText: {
        color: "white",
